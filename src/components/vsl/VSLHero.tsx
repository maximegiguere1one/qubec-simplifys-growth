            ...
            <div className="relative w-full max-w-4xl mx-auto">
              ...
              <div className="text-center mt-4 animate-fade-in">
                <p className="text-lg sm:text-xl text-muted-foreground font-medium max-w-4xl mx-auto">
                  Regarde cette courte vidéo et découvre comment <span className="text-primary font-semibold">dizaines d'entrepreneurs</span> sauvent du temps chaque semaine.
                </p>
              </div>
            </div>
          </div>
