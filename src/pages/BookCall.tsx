...
const BookCall = () => {
  ...
  return <div className="min-h-[100dvh] bg-gradient-background py-8 sm:py-12 md:py-16">
      <div className="container mx-auto container-mobile max-w-4xl">
        ...
        bookingVariant === "enhanced" ? <EnhancedBookingFlow leadId={leadId} quizResults={quizResults} prefilledData={{
        ...
        }} /> : <OptimizedBookingForm prefilledData={{
          name: quizResults?.contactInfo?.name,
          email: quizResults?.contactInfo?.email,
          phone: quizResults?.contactInfo?.phone
        }} onSuccess={(id?: string) => {
